...
JNIEXPORT void JNICALL Java_jwtc_chess_JNI_putPieceHouse(JNIEnv* env,
                                                         jobject thiz,
                                                         jint pos,
                                                         jint piece);
JNIEXPORT int JNICALL Java_jwtc_chess_JNI_getNumHouse(JNIEnv* env,
                                                      jobject thiz,
                                                      jint turn,
                                                      jint piece);
JNIEXPORT void JNICALL
Java_jwtc_chess_JNI_setNumHouse(JNIEnv* env, jobject thiz, jint turn, jint piece, jint num);
